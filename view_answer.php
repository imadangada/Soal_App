                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">View Answers</h6>
...
if (isset($_GET["q_check"])) {
    ...
    if ($query->rowCount() > 0) {
                     ...
                     <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
             <?php echo htmlentities($result->question); ?>
       ...
       <?php echo htmlentities($result->answer); ?>
            </div>
        </div>
<?php }}}?>
            </form>
