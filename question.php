    ...
    <div class="question data-tilt">
        ...
        <div class="row">
            <div class="col-lg-6 col-6">
                    <a href="#" style="color: #074954;  margin-top:-10px;  padding:10px 15px; border-radius:30px;  box-shadow: -10px -10px 15px rgba(255, 255, 255, 0.5), 10px 10px 15px rgba(70, 70, 70, 0.12); text-decoration: none;">Answered <i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a>
            </div>
            <div class="col-lg-6 col-6">
                    <form action="view_answer.php" method="get">
                        <input type="hidden" name="q_id" value="<?php echo htmlentities($result->q_id); ?>">
                     <button name="q_check" style="border-style: none; color: #074954;  font-size: 15px;  margin-top:-10px; box-shadow: -10px -10px 15px rgba(255, 255, 255, 0.5), 10px 10px 15px rgba(70, 70, 70, 0.12); padding:10px 15px; border-radius:30px; text-decoration: none; -webkit-appearance:none">View Answer </button></form>
            </div>
        </div>
               <?php
} else {
