        ...
        <section class="clean-block about-us">
            <div class="container">
                <div class="block-heading">
                    <h2 style="color: #074954;">Question I Answered</h2>
                    <hr>
                </div>
...
$sql = "SELECT users.name, questions.date_ask, questions.question, questions.status, questions.answer, questions.q_id FROM questions INNER JOIN users ON questions.user_id = users.user_id WHERE questions.status='1' AND questions.ulama_id='$uid'  ORDER BY questions.q_id DESC";
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
           ...
           <div class="bg-success text-white text-center">
            Answer<br><?php echo htmlentities($result->answer);?>
        </div>
            </form>
